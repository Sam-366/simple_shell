...
/**
 * copy_info - function that copies info to create a new env
 *
 * @name: name of env
 *
 * @value: value of env
 *
 * Return: returns a new env or alias.
 */
...
/**
 * _setenv - function that compares env variables names with the name passed.
 *
