...
/**
 * add_sep_node_end - function that adds a separator found at the end of a sep_list.
 *
...
/**
 * add_line_node_end - function that adds a command line at the end of a line_list.
 *
