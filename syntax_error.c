 ...
 * @last: last char read
 *
 * Return: returns index of error. 0 when there are no errors
 */
...
/**
 * first_char - function that finds index of the first char
 *
 * @input: input
 *
 * @i: index
...
/**
 * print_syntax_error - function that prints when a syntax error is found
 *
